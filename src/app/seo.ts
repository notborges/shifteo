...
const DEFAULT_TITLE = 'Shifteo — Convert images locally in your browser'
const DEFAULT_DESCRIPTION = 'Convert images locally in your browser. Zero uploads. Zero tracking.'
...
export function applyRouteSeo(route: RouteLocationNormalized) {
  ...
  setMetaContent('property', 'og:image:alt', `${title} — Shifteo`)
  ...
  setMetaContent('name', 'twitter:image:alt', `${title} — Shifteo`)
